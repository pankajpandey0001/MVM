...
| Role / User | Email ID | Name | Password |
| :--- | :--- | :--- | :--- |
| **User 1 (Admin)** | `admin1@example.com` | Admin One | `Pankaj@455161` |
| **User 2 (Admin)** | `admin2@example.com` | Admin Two | `Pankaj@455161` |
| **User 3 (Vendor)** | `vendor1@example.com` | Vendor One | `Pankaj@455161` |
| **User 4 (Vendor)** | `vendor2@example.com` | Vendor Two | `Pankaj@455161` |
| **User 5 (Vendor)** | `vendor3@example.com` | Vendor Three | `Pankaj@455161` |
| **User 6 (Vendor)** | `vendor4@example.com` | Vendor Four | `Pankaj@455161` |
